...
with source as (
    select * from {{ source('trackdechets_production', 'bsdasri_revision_request') }} b
    {% if is_incremental() %}
...
SELECT
    ...
    assumeNotNull(toString("bsdasriId")) as bsdasri_id,
    ...
    toNullable(toString("destinationWastePackagings")) as destination_waste_packagings,
    toNullable(toFloat64("destinationReceptionWasteWeightValue")) as destination_reception_waste_weight_value,
    ...
    toNullable(toDecimal256("initialDestinationReceptionWasteWeightValue", 30)) as initial_destination_reception_waste_weight_value,
    toNullable(toString("initialDestinationWastePackagings")) as initial_destination_waste_packagings,
    ...
    toNullable(toString("initialEmitterPickupSitePostalCode")) as initial_emitter_pickup_site_postal_code,
