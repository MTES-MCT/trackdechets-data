...
SELECT
    ...
    toNullable(toTimezone(toDateTime64("workerWorkSignatureDate",6),'Europe/Paris')) as worker_work_signature_date,
    ...
    toNullable(toTimezone(toDateTime64("workerCertificationValidityLimit",6),'Europe/Paris')) as worker_certification_validity_limit,
