...
SELECT
    ...
    toNullable(toDateTime64("handedOverToDestinationSignatureDate", 6, 'Europe/Paris') - timeZoneOffset(toTimeZone("handedOverToDestinationSignatureDate",'Europe/Paris'))) as handed_over_to_destination_signature_date,
