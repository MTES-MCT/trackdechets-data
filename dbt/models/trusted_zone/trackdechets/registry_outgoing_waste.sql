...
with source as (
    select * from {{ source('trackdechets_production', 'registry_outgoing_waste') }} b
    {% if is_incremental() %}
...
SELECT
    ...
    assumeNotNull(toTimezone(toDateTime64("dispatchDate",6),'Europe/Paris')) as dispatch_date,
