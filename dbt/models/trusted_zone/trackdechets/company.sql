...
SELECT
    ...
    toNullable(toTimezone(toDateTime64("verifiedAt",6),'Europe/Paris')) as verified_at,
    ...
    toNullable(toTimezone(toDateTime64("isDormantSince",6),'Europe/Paris')) as is_dormant_since,
    toNullable(toTimezone(toDateTime64("hasEnabledRegistryDndFromBsdSince",6),'Europe/Paris')) as has_enabled_registry_dnd_from_bsd_since
 FROM source