...
SELECT
    ...
    toNullable(toTimezone(toDateTime64("acceptationDate",6),'Europe/Paris')) as acceptation_date,
    ...
    toNullable(toTimezone(toDateTime64("acceptationSignatureDate",6),'Europe/Paris')) as acceptation_signature_date,
    ...
    toNullable(toTimezone(toDateTime64("operationDate",6),'Europe/Paris')) as operation_date,
    ...
    toNullable(toTimezone(toDateTime64("operationSignatureDate",6),'Europe/Paris')) as operation_signature_date,
