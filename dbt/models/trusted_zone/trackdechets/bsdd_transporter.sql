...
SELECT 
    ...
    toNullable(toTimezone(toDateTime64("transporterValidityLimit", 6), 'Europe/Paris')) AS transporter_validity_limit,
    ...
    toTimezone(toDateTime64("createdAt",6),'Europe/Paris') AS created_at,
    toTimezone(toDateTime64("updatedAt",6),'Europe/Paris') AS updated_at,
