select
    ...
    quantity_received,
    quantity_refused,
    null                              as accepted_quantity_packagings,
...
select
    ...
    transporters_org_ids                 as transporters_sirets,
    null                                 as transporter_company_name,
    null                                 as transport_mode,
...
select
    ...
    toNullable(id)                                 as readable_id,
    toNullable(created_at)                         as created_at,
    first_transporter_transport_taken_over_at      as taken_over_at,
    destination_reception_date                     as received_at,
    destination_operation_date                     as processed_at,
    status,
    null                                           as no_traceability,
    is_draft,
    toDecimal256(destination_reception_weight, 30) as quantity_received,
    null                                           as quantity_refused,
    null
        as accepted_quantity_packagings,
    destination_operation_code                     as processing_operation,
