...
select
    ...
    ce.verification_comment
        as company_verification_comment,
    ce.verified_at                               as company_verified_at,
    ce.allow_bsdasri_take_over_without_signature
        as company_allow_bsdasri_take_over_without_signature,
    ...
    ce.libelle_sous_classe
        as company_libelle_sous_classe,
    ce.etat_administratif_etablissement
        as company_etat_administratif_etablissement,
    ce.code_commune_insee
        as company_code_commune_insee,
    ce.code_departement_insee
        as company_code_departement_insee,
