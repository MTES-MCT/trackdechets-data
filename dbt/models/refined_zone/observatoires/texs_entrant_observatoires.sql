...
select
    ...
    emitter_company_org_id as emetteur_siret_etablissement,
    emitter_company_name as emetteur_nom_etablissement,
    emitter_pickup_site_address as emetteur_adresse_point_de_retrait,
    emitter_pickup_site_postal_code as emetteur_code_postal_point_de_retrait,
    emitter_pickup_site_city as emetteur_ville_point_de_retrait,
    emitter_pickup_site_country_code as emetteur_code_pays_point_de_retrait,
    emitter_company_address as emetteur_adresse_etablissement,
    emitter_company_postal_code as emetteur_code_postal_etablissement,
    emitter_company_city as emetteur_ville_etablissement,
    emitter_company_country_code as emetteur_code_pays_etablissement,
    ...
    destination_parcel_insee_codes as parcelles_destination_codes_insee,
    destination_parcel_numbers as parcelles_destination_numeros,
    destination_parcel_coordinates as parcelles_destination_coordonnees,
    eco_organisme_name as eco_organisme_siret,
    eco_organisme_siret as eco_organisme_nom,
    arrayFilter(
        x -> notEmpty(x),
