{{
  config(
    ...
    query_settings = {
        ...
        "grace_hash_join_initial_buckets":64
    }
    )
}}
...
select
    ...
    transporter_company_name
        as transporteur_nom_etablissement,
    transporter_company_siret
        as transporteur_siret_etablissement,
    transporter_company_address
        as transporteur_adresse_etablissement,
    transporter_acceptation_status
        as transporteur_dechet_statut_acceptation,
    transporter_waste_weight_value
        as transporteur_dechet_quantite,
    transporter_waste_volume
        as transporteur_dechet_volume,
    transporter_waste_refusal_reason
        as transporteur_dechet_raison_refus,
    transporter_waste_refused_weight_value
        as transporteur_dechet_quantite_refus,
    ...
    transporter_transport_mode
        as transporteur_mode_transport,
